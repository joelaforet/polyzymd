...
Built-in plugins such as `rmsf`, `distances`, `contacts`, `rg`, `rmsd`,
`secondary_structure`, and `catalytic_triad` show real package shapes. Their private helper modules are useful examples of organization:
