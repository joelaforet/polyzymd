...
Use these pages for MDAnalysis-native job execution, frame selection, the
replicate lifecycle, artifact storage, and shared MDAnalysis primitives.
...
Universe provenance and shared MDAnalysis primitives <analyses_mda/universe_primitives>
```
