...
class ProtocolReport(BaseModel):
    ...
    def to_agent_text(self) -> str:
        ...
        report from partial data says so on the lines right after the header.
        The output has no table borders, no colour and no blank lines.
        """
        ...
        lines = [
            header,
            *(f"PARTIAL: {text}" for text in self.partial),
