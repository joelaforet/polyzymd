"""SASA plugin artifact and computation helpers.

This module provides plugin-private helpers for SASA analyses that need
selection validation, atom-level and residue-level SASA traces, and raw
...
def build_sasa_artifact_contract(
    *,
    ...
    return SASAArtifactContract(
        ...
        compatibility_version=SASA_ARTIFACT_COMPATIBILITY_VERSION,
        producer="polyzymd.analyses.sasa._artifacts",
