...
Canonical location — moved from ``analysis.exposure.enrichment`` during the
...
For a polymer type P and residue group G (e.g. "aromatic"):
    ...
    observed[t]  = fraction of residues in G intersect {exposed at t} that P contacts
    expected[t]  = |G intersect {exposed at t}| / |{all protein residues exposed at t}|
