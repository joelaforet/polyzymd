...
.. versionchanged:: 1.3.0
    Migrated from ``polyzymd.compare.triad_formatters`` into the catalytic
    triad analysis package so that contributors find all triad-related code in
    one place.
"""

from __future__ import annotations

from polyzymd.analyses.catalytic_triad._comparison_results import TriadComparisonResult
