...
measurement plugin. Advanced MDAnalysis-native package scaffolds are reserved
for a follow-up implementation and are not generated by this transitional
scaffold.
...
def _build_spec(
    ...
    advanced : bool, optional
        If True, request an advanced package scaffold. Advanced scaffolds are
        disabled until the MDAnalysis-native template is implemented.
    ...
    if advanced or effective_style in ADVANCED_STYLES:
        raise ValueError(
            "Advanced analysis scaffolds are temporarily unavailable while the old runner "
            "templates are removed. Use the default measurement scaffold, or wait for the "
            "MDAnalysis-native advanced scaffold."
        )
...
def generate_scaffold(
    ...
    *,
    ...
    advanced : bool, optional
        Request an advanced package scaffold. This currently raises until the
        MDAnalysis-native advanced scaffold replaces the removed runner template,
        by default False.
    force : bool, optional
