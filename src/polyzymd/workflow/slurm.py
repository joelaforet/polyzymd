...
batch scripts for MD simulations.  Supports both the legacy
daisy-chain model (separate initial/continuation templates) and the
self-resubmitting model (single unified template).
"""
...
class SlurmScriptGenerator:
    ...
    # Legacy template for initial simulation jobs (daisy-chain architecture).
    # DEPRECATED: Use JOB_TEMPLATE and generate_job_script() instead.
...
"""
    ...
    # Legacy template for continuation jobs (daisy-chain architecture).
    # DEPRECATED: Use JOB_TEMPLATE and generate_job_script() instead.
...
"""
    ...
    # =====================================================================
    # Unified self-resubmitting job template (new architecture)
    # =====================================================================
    # This template replaces the separate initial/continuation templates.
...
"""
    ...
    def generate_initial_job(
        ...
        .. deprecated::
            Use :meth:`generate_job_script` instead (self-resubmitting model).
        ...
        """
        warnings.warn(
            "generate_initial_job() is deprecated and will be removed in v2.0. "
            "Use generate_job_script() instead.",
            DeprecationWarning,
            stacklevel=2,
        )
    ...
    def generate_continuation_job(
        ...
        """
        warnings.warn(
            "generate_continuation_job() is deprecated and will be removed in v2.0. "
            "Use generate_job_script() instead.",
            DeprecationWarning,
            stacklevel=2,
        )
    ...
    # ------------------------------------------------------------------
    # Unified self-resubmitting job generation (new architecture)
    # ------------------------------------------------------------------
